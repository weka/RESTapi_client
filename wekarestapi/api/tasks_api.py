...
class TasksApi(object):
    ...
    def abort_tasks(self, uid, **kwargs):  # noqa: E501
        """Abort task  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.abort_tasks(uid, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.abort_tasks_with_http_info(uid, **kwargs)  # noqa: E501
        else:
            (data) = self.abort_tasks_with_http_info(uid, **kwargs)  # noqa: E501
            return data

    def abort_tasks_with_http_info(self, uid, **kwargs):  # noqa: E501
        """Abort task  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.abort_tasks_with_http_info(uid, async_req=True)
        >>> result = thread.get()
        ...
        if ('uid' not in params or
                params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `abort_tasks`")  # noqa: E501
