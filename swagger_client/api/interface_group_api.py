...
class InterfaceGroupApi(object):
    ...
    def add_ip_range_to_interface_group(self, body, uid, **kwargs):  # noqa: E501
        """Add ip range to interface group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_ip_range_to_interface_group(body, uid, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_ip_range_to_interface_group_with_http_info(body, uid, **kwargs)  # noqa: E501
        else:
            (data) = self.add_ip_range_to_interface_group_with_http_info(body, uid, **kwargs)  # noqa: E501
            return data

    def add_ip_range_to_interface_group_with_http_info(self, body, uid, **kwargs):  # noqa: E501
        """Add ip range to interface group  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_ip_range_to_interface_group_with_http_info(body, uid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method add_ip_range_to_interface_group" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `add_ip_range_to_interface_group`")  # noqa: E501
        # verify the required parameter 'uid' is set
        if ('uid' not in params or
                params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `add_ip_range_to_interface_group`")  # noqa: E501
    ...
    def delete_port_from_interface_group(self, uid, host_uid, port, **kwargs):  # noqa: E501
        ...
        :param str uid: Interface group uid (required)
        :param str host_uid: Host uid (required)
        :param str port: Port to delete (required)
        :return: InlineResponse200
                 If the method is called asynchronously,
                 returns the request thread.
        """
