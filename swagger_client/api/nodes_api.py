...
class NodesApi(object):
    ...
    def get_node(self, uid, **kwargs):  # noqa: E501
        """Get node  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_node(uid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str uid: Node uid (required)
        ...
        if kwargs.get('async_req'):
            return self.get_node_with_http_info(uid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_node_with_http_info(uid, **kwargs)  # noqa: E501
            return data

    def get_node_with_http_info(self, uid, **kwargs):  # noqa: E501
        """Get node  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_node_with_http_info(uid, async_req=True)
        >>> result = thread.get()
        ...
        if ('uid' not in params or
                params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `get_node`")  # noqa: E501
