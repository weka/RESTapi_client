...
class LicenseApi(object):
    ...
    def reset_license(self, **kwargs):  # noqa: E501
        """Reset license  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reset_license(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reset_license_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reset_license_with_http_info(**kwargs)  # noqa: E501
            return data

    def reset_license_with_http_info(self, **kwargs):  # noqa: E501
        """Reset license  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reset_license_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def set_license(self, **kwargs):  # noqa: E501
        ...
        Classic license (license) or PAYG license (plan_id,secret_key,[url])  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
