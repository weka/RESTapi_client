...
class NfsPermissionsBody(object):
    ...
    def __init__(self, filesystem=None, group=None, path=None, permission_type=None, root_squashing=None, squash_mode=None, anon_uid=None, anon_gid=None, obs_direct=None):  # noqa: E501
