...
class NetdevNetDevices(object):
    ...
    def __init__(self, mac_address=None, mtu=None, is_virtual=None, interface_alias=None, numa=None, aws=None, interface_name=None, max_vfs_num=None, vendor=None, slave_devices=None, pci_slot=None, device=None, driver=None):  # noqa: E501
