...
class InlineResponse2008DataBucketsInfo(object):
    ...
    swagger_types = {
        ...
        'fill_level_alerts_percent': 'list[float]',
    ...
    attribute_map = {
        ...
        'fill_level_alerts_percent': 'fillLevelAlertsPercent',
    ...
    def __init__(self, average_fill_level_ppm_min_since_last_event=None, fill_level_alerts_percent=None, thin_provision_state=None, average_fill_level_ppm=None, shrunk_at_generation=None, placement_allocation_threshold_ppm=None, max_prefetch_rp_cs=None):  # noqa: E501
        ...
        self._fill_level_alerts_percent = None
        ...
        if fill_level_alerts_percent is not None:
            self.fill_level_alerts_percent = fill_level_alerts_percent
    ...
    @property
    def fill_level_alerts_percent(self):
        """Gets the fill_level_alerts_percent of this InlineResponse2008DataBucketsInfo.  # noqa: E501


        :return: The fill_level_alerts_percent of this InlineResponse2008DataBucketsInfo.  # noqa: E501
        :rtype: list[float]
        """
        return self._fill_level_alerts_percent

    @fill_level_alerts_percent.setter
    def fill_level_alerts_percent(self, fill_level_alerts_percent):
        """Sets the fill_level_alerts_percent of this InlineResponse2008DataBucketsInfo.


        :param fill_level_alerts_percent: The fill_level_alerts_percent of this InlineResponse2008DataBucketsInfo.  # noqa: E501
        :type: list[float]
        """

        self._fill_level_alerts_percent = fill_level_alerts_percent
