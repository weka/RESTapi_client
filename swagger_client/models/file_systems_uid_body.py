...
class FileSystemsUidBody(object):
    ...
    def __init__(self, new_name=None, total_capacity=None, ssd_capacity=None, thin_provision_min_ssd=None, thin_provision_max_ssd=None, auth_required=None):  # noqa: E501
